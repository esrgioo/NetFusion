...
export default async function About() {
  ...
  return (
    <section className="px-4 md:px-20 md:max-w-[1200px] m-auto box-content py-6 lg:py-10">
      <div className="flex flex-col gap-y-4 md:gap-y-8 md:items-center md:justify-center text-left md:text-center md:max-w-5xl mx-auto">
        ...
        <h2 className="md:px-16 md:text-5xl md:font-[300] md:leading-[110%] font-[400] text-xl leading-[130%] text-slate-700/80 text-subtitle-bold py-0 mb-8">
          Empowering Small Business Owners to Make Deeper Connections
        </h2>
        <Abouthero image={teams?.images.fields.file.url} />
      </div>
      <div className="px-4 md:px-15 box-content py-8 lg:py-10 gap-y-5 mt-8">
        <div className="break-words mb-8">
          <h2 className="text-5xl font-medium mb-4 md:text-center">About us</h2>
        </div>
        <div className="flex flex-col gap-x-20 lg:mt-14 lg:gap-y-9 lg:flex-row text-xl leading-9">
          <div className="basis basis-[50%]">
            <p>
              At NetFusion, we are proud to be a thriving online network with
              over 9 million members connecting business owners in 35,000 local
              communities. As the go-to small business network, NetFusion is
              committed to simplifying the process of forming genuine
              connections for small business owners.We believe that small
              businesses are the backbone of our economy and play a vital role
              in the vibrancy of local communities.
            </p>
          </div>
          <div className="mt-4 lg:mt-0 basis basis-[50%]">
            <p>
              By joining the NetFusion network, business owners can tap into
              opportunities to gain local referrals, expand their customer base,
              form genuine relationships, and exchange insights and guidance
              with others in their industry. Join the rest of your community on
              NetFusion and uncover the possibilities to take your business to
              the next level. Our community is built on the principles of trust,
      ...
      <div className="px-4 md:px-20 m-auto box-content py-6 lg:py-10 text-center text-2xl bg-blue-100 my-12">
        <div className="break-words">
          <h2
            className="text-inherit text-subtitle-bold leading-[110%] md:leading-[110%] md:text-title-bold"
            data-testid="headline"
          >
            Join NetFusion for free and explore the tools and resources your
      ...
      <div className="px-4 md:px-20 m-auto box-content py-6 lg:py-10">
        <div className="break-words">
          <h2
        ...
        <div className="flex flex-col lg:flex-row gap-x-20 lg:mt-14 [&amp;_img]:max-w-full text-xl leading-relaxed">
          <div className="[&amp;>p]:leading-snug [&amp;>p]:text-xl [&amp;>p]:md:text-[32px] basis-[50%] [&amp;>p]:mt-0 [&amp;>p]:text-inherit [&amp;>p]:font-serif [&amp;>p]:font-regular">
            <p>
              ...
              local business owners about how technology could help them grow.
              And then it hit us: what they really wanted was a simple way to
              connect with other businesses on their street.
            </p>
          </div>
          <div className="mt-4 lg:mt-0 basis basis-[50%] [&amp;>p]:text-lg [&amp;>p]:md:text-2xl/[165%] [&amp;>p]:mt-0 [&amp;>p]:text-inherit [&amp;>p]:font-serif [&amp;>p]:font-regular">
            <p>
              ...
              and collaborate with their fellow business owners nearby. We
              wanted to bridge the gap and empower local businesses to form
              meaningful connections within their own communities.
            </p>
            <p>
              NetFusion became the solution, uniting business owners and
              providing them with the tools to grow and succeed together. Our
              story is all about fostering growth, building relationships, and
