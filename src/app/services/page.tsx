...
const Services = () => {
  return (
    <section className="px-4 md:px-10 md:max-w-[1400px] m-auto box-content py-6 lg:py-20">
      ...
      <div className="space-y-2 mb-8 xl:grid xl:grid-cols-4 xl:pt-14">
        <div className="=xl:col-span-1 xl:translate-x-8 2xl:translate-x-0">
